...
## Phase 6: E2EE & Firebase Migration (v0.13.0)
- [x] Migrate transport layer to Firebase Realtime Database
- [x] Implement AES-256-GCM End-to-End Encryption
- [x] Set up Firebase Local Emulator Suite for testing
- [x] Enforce strict URL safety protocols
- [x] Purge all legacy bookmark-sync artifacts
- [x] Transition test suite to real modules & real crypto
